...
uses
  ...
  function jc_StcSet(obj: jc_stc; const scope: pchar; obj: jc_obj): bool; cdecl; external;
  ...
  function jc_ArrSet (obj: jc_arr; index: u32; obj: jc_obj): bool; cdecl; external;
  function jc_ArrPush(obj: jc_arr; obj: jc_obj): bool; cdecl; external;
  function jc_ArrDel (obj: jc_arr; index: u32): bool; cdecl; external;



  // Parse
  function jc_Parse(const fpath: pchar): jc_stc; cdecl; external;
  function jc_ParseRaw(const fpath: pchar): jc_stc; cdecl; external;
  function jc_ParseBin(const fpath: pchar): jc_stc; cdecl; external;

  function jc_WriteRaw(const fpath: pchar; data: jc_stc): bool; cdecl; external;
  function jc_WriteBin(const fpath: pchar; data: jc_stc): bool; cdecl; external;
